...
public final class Region {
	...
	public BlockBox getBlockBox() {
		return BlockBox.create(this.min.getStartPos(), this.max.getStartPos().add(15, 255, 15));
	}
	...
	public void export(Path temp, EnumSet<SaveComponent> components) throws IOException {
		...
		EntityChunkDataAccess entityDst = new EntityChunkDataAccess(this.dimension, 
				temp.resolve(dir).resolve("entities").toFile(), this.dimension.getServer().getDataFixer(), false, 
