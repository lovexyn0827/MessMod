...
public class RenderedBitmap extends Shape {
	...
	private void uploadTexture() {
		...
		for (int i = 0; i < pixelCnt; i++) {
			im.setColor(i % this.width, i / this.width, this.pixels[i]);
		}
	...
	@Override
	protected void renderFaces(MatrixStack matrices, Tessellator tessellator, BufferBuilder builder, 
	...
	@Override
	protected void renderLines(MatrixStack matrices, Tessellator tessellator, BufferBuilder buffer, 
