				...
				.then(argument("corner1", BlockPosArgumentType.blockPos())
						.then(argument("corner2", BlockPosArgumentType.blockPos())
								...
								.then(literal("replace")
										.then(argument("from", ItemStackArgumentType.itemStack())
												.then(argument("to", ItemStackArgumentType.itemStack())
														.executes((ct) -> {
															BlockPos p1 = BlockPosArgumentType.getBlockPos(ct, "corner1");
															BlockPos p2 = BlockPosArgumentType.getBlockPos(ct, "corner2");
								...
								.then(literal("sorter")
										.then(argument("main", ItemStackArgumentType.itemStack())
												.then(argument("occupier", ItemStackArgumentType.itemStack())
														.executes((ct) -> {
															BlockPos p1 = BlockPosArgumentType.getBlockPos(ct, "corner1");
															BlockPos p2 = BlockPosArgumentType.getBlockPos(ct, "corner2");
